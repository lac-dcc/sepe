...
RQ2 results will be in `results/hash-performance.txt`.
RQ1 partial results will be in the other files in `results/`.
Specifically, for true collision, you will have to execute the script for RQ3.
The final lines of the results generated by the RQ3 script will report the true collisions.
